...
public class PayResultButtons {
    ...
    public static List<PayResultButtons> of() {
        return List.of(ButtonsForImage.of(6, 2, "none", "https://www.google.com", "https://picsum.photos/id/237/200/300"),
                ...
                ButtonsForText.of(6, 3, "none", "발신자명,메시지", "<font color=#323232>From." + " 강시혁" + "</font>" + "<br><br><font color=#323232>Message: 생일 축하한다~!</font>"+"<br><br><font color=#323232><b>Code : " + "dsfksjdfkjsdfhisdholvaksdfds" + "</b></font><br><br><font color=#323232><b>Expire Date : " + "02/07/23" + "</b></font>", "small", "middle", "left"),
